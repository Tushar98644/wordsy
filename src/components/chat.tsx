...
import { AudioLines, BarChart3, ChevronDown, HelpCircle, Lightbulb, MessageCircle, MoreHorizontal, Paperclip, PenTool, Search, Mic } from "lucide-react"
...
export default function ChatInterface() {
    ...
    return (
        <div className="min-h-screen bg-[#212121] text-white flex flex-col relative">
            {/* Background content with conditional blur */}
            <div className={`flex flex-col min-h-screen ${isWelcomeModalOpen ? 'blur-xs' : ''}`}>
                {/* Top header */}
                <div className="flex justify-end items-center p-6 gap-3">
                    {isSignedIn ? (
                        ...
                        <>
                            <Button onClick={() => handleOpenModal()} className="bg-white text-black hover:bg-gray-100 rounded-full px-6 py-2 text-[14px] font-medium">
                                Log in
                            </Button><Button variant="ghost" className="text-gray-300 hover:text-white hover:bg-gray-800 text-[14px] font-medium">
                                Sign up for free
                            </Button>
                        </>
                    )}
                            ...
                            <div className="absolute right-4 top-1/2 -translate-y-1/2">
                                ...
                                >
                                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10.894 2.553a1 1 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" />
                                    </svg>
                                </Button>
                            </div>
